...
export STORAGE_BASE_URL="http://localhost:9000/kms"
...
# Export the public storage labels for single KMS core (centrealized)
export PUBLIC_STORAGE_LABEL="PUB"
