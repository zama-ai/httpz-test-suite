...
# mkdir -p temp; docker run --rm -v $PWD/temp:/keys ghcr.io/zama-ai/kms-service-dev:v0.8.2-rc3 ./bin/kms-gen-keys centralized --write-privkey --pub-url file://./keys --priv-url file://./keys --overwrite
