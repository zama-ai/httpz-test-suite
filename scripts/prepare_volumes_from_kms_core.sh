...
# mkdir -p res/keys; docker run -e RUST_BACKTRACE=1 -v "$PWD/res/keys:/app/kms/core/service/keys" "ghcr.io/zama-ai/kms-service-dev:v0.8.2-rc2" "./bin/kms-gen-keys" centralized  --write-privkey --pub-url file://./keys --priv-url file://./keys --overwrite
